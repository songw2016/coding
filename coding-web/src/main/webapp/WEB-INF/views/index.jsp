...
<div class="wrap-body">
    <!-- Intro -->
    <div id="intro">
        <span class="line-1">马坝</span>
        <span class="line-2">欢乐谷</span>
        <span class="line-3">良辰美景欢乐小镇</span>
        <span class="line-4"><a href="#">江苏</a><a href="#">盱眙</a></span>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="collapse navbar-collapse navbar-ex1-collapse">
                        <ul class="nav navbar-nav">
                            <li class="active"><a href="${webUrl}/index">首页</a></li>
                            <li><a href="${webUrl}/happyvalley">快乐小镇</a></li>

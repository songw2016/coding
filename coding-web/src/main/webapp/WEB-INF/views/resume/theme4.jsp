...
<head>
    ...
    <link rel="stylesheet" href="${staticUrl}/css/theme4.css" type="text/css" media="screen" />
    <link rel="stylesheet" href="${staticUrl}/css/prettyPhoto.css" type="text/css" media="screen" />
    <link rel="stylesheet" href="${staticUrl}/css/print.css" type="text/css" media="print" />
</head>
<body>
...
<div id="wrapper">
    ...
    <!--BIO TITLE-->
    <h2 id="titleName" class="sectionHead">马玉亮</h2>
    ...
    <div id="bio">
        ...
        <!--SOCIAL LINKS-->
        <div id="socialIcons">
            <a class="socialIcon" target="_blank" id="facebookIcon" href="http://themolitor.com/facebook"></a>
        ...
        <p>
            ...
            <br/>具有丰富项目经验，良好的变成习惯以及有较强的学习适应能力。
        </p>
    ...
    <div id="contactform"  class="contact">
        <form action="send.php" method="post" >
            ...
            <input name="send" id="submit_btn" type="button" class="round3 clearRight" value="Send Message" />
...
<script src="${staticUrl}/js/prettyPhoto.js"></script>
<script src="${staticUrl}/js/backPosition.js"></script>
<script src="${staticUrl}/js/theme4.js"></script>
<script>

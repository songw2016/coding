        ...
        that.show = function (prevAnim) {
            ...
            for (i = 0; i < s.wheels.length; i++) {
                ...
                for (label in s.wheels[i]) {
                    ...
                    html += '<td><div class="dwl">' + label + '</div><div class="dwwl dwrc dwwl' + l + '">' + (s.mode != 'scroller' ? '<div class="dwwb dwwbp" style="height:' + hi + 'px;line-height:' + hi + 'px;"><span>+</span></div><div class="dwwb dwwbm" style="height:' + hi + 'px;line-height:' + hi + 'px;"><span>&ndash;</span></div>' : '') + '<div class="dww" style="height:' + (s.rows * hi) + 'px;min-width:' + s.width + 'px;"><div class="dw-ul">';
                    // Create wheel values
...
(function ($) {
    $.mobiscroll.xn.zh = $.extend($.mobiscroll.xn.zh, {
